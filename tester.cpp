...
int main(){
    ...
    std::cout << "insertion time: " << elapsed_seconds.count() << "s\n";
    string question = "Who was Gandhi referring to when he said, I have no doubt that they are brave people, but they are misguided?";
